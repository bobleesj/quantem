...
(`/home/owner/ssd/_hf_stage_gold30/gold_30mrad1.3mx04/`, 27x10000 frames of
...
### Throughput (measured, real gold, mjgoat RTX PRO 6000, 1000 frames x5 reps)
...
bslz4 chunks (116 MB) as an HTTP companion file. In headed Chrome on mjgoat, no
Python:
...
the mjgoat headed Chrome ran on `DISPLAY=:1` which is **Xvfb (no GPU)**, so WebGPU
