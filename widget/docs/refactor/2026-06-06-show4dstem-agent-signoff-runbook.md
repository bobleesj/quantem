...
```bash
ssh mjgoat 'cd /home/owner/repos/quantem/widget && /home/owner/miniforge3/bin/mamba run -n cuda-env python - <<'"'"'PY'"'"'
from quantem.widget import load, Show4DSTEM
master = "/home/owner/ssd/data/samsung/20260512_dram/Samsung_3.6Mx_21.4mrad_185mmcl_20pA_29_master.h5"
...
from quantem.widget import load, Show4DSTEM
masters = [
    "/home/owner/ssd/data/samsung/20260512_dram/Samsung_3.6Mx_21.4mrad_185mmcl_20pA_29_master.h5",
    "/home/owner/ssd/data/samsung/20260512_dram/Samsung_3.6Mx_21.4mrad_185mmcl_20pA_30_master.h5",
]
...
w = Show4DSTEM(
    ...
    backend="web",
    offline_codec="bslz4",
    data_url="/home/owner/ssd/tmp/show4dstem-agent-full-webgpu",
    title="Show4DSTEM full no-bin WebGPU export",
    precompute_virtual_images=False,
    verbose=True,
)
w.export_html("/home/owner/ssd/tmp/show4dstem-agent-full-webgpu/index.html")
```

Serve and drive from headed Chrome on mjgoat:

```bash
cd /home/owner/ssd/tmp/show4dstem-agent-full-webgpu
...
```bash
# mjgoat
ssh mjgoat 'pkill -f "http.server 8897" || true; pkill -f "cdp-show4dstem" || true; rm -rf /home/owner/ssd/tmp/show4dstem-agent-full-webgpu; pgrep -af "show4dstem-agent|cdp-show4dstem|http.server 8897|playwright" || true'
