...
- Use Phil/Mac for bounded MPS tests only. Do not run Samsung-scale full-data
  browser/MPS stress tests on Phil unless explicitly requested.
- Use mjgoat/Linux for full Show4DSTEM CUDA and heavy WebGPU/offline tests.
