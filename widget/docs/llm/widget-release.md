...
- mjgoat has Chrome on `DISPLAY=:0`.
- Real Samsung data is available, currently
  `/home/owner/ssd/data/samsung/20260512_dram`.
- Use copied or same-filesystem hardlinked test folders under `/home/owner`.
...
- Measure `requestAnimationFrame` FPS; target is at least 30 fps, expect about
  60 fps on mjgoat for the bounded browser path.
