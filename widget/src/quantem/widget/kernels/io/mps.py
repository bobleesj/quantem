...
# Samsung no-bin setting; larger groups can be tested with QT_MPS_LZ4_Y. The
...
class MPSDecompressor:
    ...
    def _read_chunk(self, filepath, comp_np, co_np, chunk_sizes):
        ...
        cuts the Samsung 512² file from 176 syscalls/data-file to 1 while still
...
#
# Performance (Samsung logic_013, 262144x192x192 uint16 = 19.3 GB, warm cache,
