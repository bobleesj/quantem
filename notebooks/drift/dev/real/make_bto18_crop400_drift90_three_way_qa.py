...
def write_readme(rows: list[dict]) -> None:
    lines = [
        ...
        "",
        "All three runs use canonical global-frame H5 scan axes and lock the common clean0/base rotation to 158.9 deg.",
        "The 90-degree scan geometry was handled once during export; no +90 reconstruction branch is used.",
    ...
    lines.extend(
        [
            ...
            "Critical control:",
            "",
            "- Case 1 uses the clean0 crop in the canonical global frame.",
            ...
            "- Do not add `clean0 + 90` after canonical export; that would double-count the 90-degree geometry.",
            "",
